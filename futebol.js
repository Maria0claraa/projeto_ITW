document.addEventListener("DOMContentLoaded", () => {
    ...
    const apiUrl = "http://192.168.160.58/Paris2024/api/Footballs/Events";
                ...
                competitionButton.addEventListener("click", () => {
                    ...
                    event.Stages.forEach(stage => {
                        ...
                        stageButton.addEventListener("click", () => {
                            ...
                            fetch(`http://192.168.160.58/Paris2024/api/Footballs?EventId=${competitionButton.dataset.eventId}&StageId=${stageButton.dataset.stageId}`)
                                .then(response => response.json())
                                .then(results => {
