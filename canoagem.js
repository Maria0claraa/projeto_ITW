document.addEventListener("DOMContentLoaded", () => {
    ...
    const apiUrl = "http://192.168.160.58/Paris2024/api/Canoe_Sprints/Events";
                ...
                competitionButton.addEventListener("click", () => {
                    ...
                    event.Stages.forEach(stage => {
                        ...
                        stageButton.addEventListener("click", () => {
                            ...
                            fetch(`http://192.168.160.58/Paris2024/api/Canoe_Sprints?EventId=${competitionButton.dataset.eventId}&StageId=${stageButton.dataset.stageId}`)
                                .then(response => response.json())
                                .then(results => {
                                    ...
                                    results.forEach(result => {
                                        ...
                                        row.innerHTML = `
                                            ...
                                            <td class="text-end">
                                                <a class="btn btn-default btn-light btn-xs" href="detalhes_canoagem.html?id=${result.Id}">
